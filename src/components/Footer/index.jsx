...
import './style.css';
import {FaBuilding, FaFacebookSquare, FaTwitterSquare, FaInstagramSquare} from 'react-icons/fa';
        ...
        <div className="footer-main-box">
            <div className="footer-first-box">
                ...
                <div className="footer-contact-box">
                    ...
                    <ul>
                        <li><FaBuilding style={Icon} /> New Delhi 91</li>
                        <li><IoMdCall style={Icon} />+91 9999968025</li>
                        <li><MdEmail style={Icon} />contacts@fuzicon.com</li>
                    </ul>
                </div>
                <div className="footer-links-box">
            ...
            <div className="footer-second-box">
                <div className="footer-second-box-icon">
                    <a href="https://www.facebook.com/"><FaFacebookSquare style={{ fontSize: "20px", color: "black" }} /></a>
                    <a href="https://www.instagram.com/"><FaInstagramSquare style={{ fontSize: "20px", color: "black", margin: '0px 30px' }} /></a>
                    <a href="https://twitter.com/login"><FaTwitterSquare style={{ fontSize: "20px", color: "black" }} /></a>
                </div>
